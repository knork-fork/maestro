...
2. Ask follow-up questions until the picture is clear. Push back on anything vague that would block a future plan. Do not ask how results should be formatted or delivered — that is handled by later phases.
